...
Template['views_account_create'].helpers({
    ...
    */
    'defaultDailyLimit': function() {
        ...
        return typeof dailyLimit != 'undefined' ? web3.fromTa(dailyLimit,'sero') :  10;
    },
    /**
    Default Name
    ...
    'submit': function(e, template){
        ...
        if(type === 'simple') {
            Wallets.insert({
                ...
                balance: '0',
                creationBlock: SeroBlocks.latest.number,
                code: code
            });
        ...
        if(type === 'multisig') {
            ...
            Wallets.insert({
                ...
                name: template.find('input[name="accountName"]').value || TAPi18n.__('wallet.accounts.defaultName'),
                balance: '0',
                dailyLimit: web3.toWei(formValues.dailyLimitAmount, 'sero'),
