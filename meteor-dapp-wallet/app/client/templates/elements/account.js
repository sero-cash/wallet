...
Template['elements_account'].helpers({
    ...
    */
    'account': function(){
        return SeroAccounts.findOne(this.account) || Wallets.findOne(this.account) || CustomContracts.findOne(this.account);
    },
    /**
    Get all tokens
    ...
    'new': function() {
        if(this.new) {
            ...
            Meteor.setTimeout(function() {
                SeroAccounts.update(id, {$unset: {new: ''}});
    ...
    */
    'creating': function(){
        ...
        var belowReorgThreshold = (blocksForConfirmation >= SeroBlocks.latest.number - (this.creationBlock - 1));
        var blockNumberCheck = SeroBlocks.latest.number - (this.creationBlock - 1) >= 0;
    ...
    */
    'unConfirmed': function() {
        ...
        var currentBlockNumber = SeroBlocks.latest.number,
