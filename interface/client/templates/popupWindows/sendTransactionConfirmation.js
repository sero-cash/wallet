...
Template['popupWindows_sendTransactionConfirmation'].onCreated(function () {
    var template = this;
    console.log('popupWindows_sendTransactionConfirmation1')
    ...
    console.log('popupWindows_sendTransactionConfirmation2')
    ...
    console.log(':::popupWindows_sendTransactionConfirmation this.autorun')
    ...
    this.autorun(function () {
        ...
        if (data) {
            ...
            if (!data.gasPrice) {
                web3.sero.getGasPrice(function (e, res) {
                    if (!e) {
            ...
            if (data.from) {
                web3.sero.getCode(data.from, function (e, res) {
                    if (!e && res && res.length > 2) {
...
Template['popupWindows_sendTransactionConfirmation'].helpers({
    ...
    */
    'estimatedFee': function () {
        ...
        if (gas && this.gasPrice) {
            return SeroTools.formatBalance(new BigNumber(gas, 10).times(new BigNumber(this.gasPrice, 10)), '0,0.0[0000000] unit', 'sero');
        }
    },
    /**
    ...
    */
    'providedGas': function () {
        ...
        console.log('this.gasPrice:::',this.gasPrice);
        if (gas && this.gasPrice) {
            return SeroTools.formatBalance(new BigNumber(gas, 10).times(new BigNumber(this.gasPrice, 10)), '0,0.0[0000000]', 'sero');
        }
    },
    /**
