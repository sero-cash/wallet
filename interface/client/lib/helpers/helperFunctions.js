...
Helpers.detectNetwork = function (hash) {
    ...
    case '0x822ec5e294e922780a7c2f2af40077c917559557a2b611e154d897719c1fc632':
        console.log('Network is Testnet #3 (Beta)');
        network.type = 'testnet';
        network.name = 'Beta';
        break;

    case '0x9cb67e4e8518ca99e0868f57321ffb4b98f93faf5a458812fcf5b2fab0e02e6d':
        console.log('Network is Testnet #4 (Alpha)');
        network.type = 'testnet';
        network.name = 'Alpha';
        break;
...
//     number = web3.fromTa(number, LocalStore.get('etherUnit'));
